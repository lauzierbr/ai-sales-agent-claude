...
class AgentClienteConfig:
    ...
    def __init__(self) -> None:
        ...
        self.system_prompt_template: str = (
            ...
            "APENAS chame registrar_feedback quando o cliente EXPLICITAMENTE criticar "
            "uma resposta anterior com palavras como: 'isso está errado', 'você errou', "
            "'essa informação está incorreta', 'o resultado não bate', 'essa resposta foi ruim'.\n"
            "NÃO é feedback: pedidos de produtos, consultas de pedidos, relatórios, "
            "perguntas normais, pedidos de busca, qualquer nova solicitação.\n"
...
class AgentRepConfig:
    ...
    def __init__(self) -> None:
        ...
        self.system_prompt_template: str = (
            ...
            "- registrar_feedback: registra feedback sobre uma resposta anterior.\n\n"
            ...
            "7. APENAS chame registrar_feedback quando o representante EXPLICITAMENTE criticar "
            "uma resposta anterior com palavras como: 'isso está errado', 'você errou', "
            "'essa informação está incorreta', 'o resultado não bate', 'essa resposta foi ruim'.\n"
            "NÃO é feedback: pedidos de produtos, consultas de pedidos, relatórios, "
            "perguntas normais, pedidos de busca, qualquer nova solicitação.\n"
            "Ao registrar: APENAS chame registrar_feedback e responda: "
            "'Obrigado pelo feedback! Ele foi registrado e será analisado pela equipe.' "
            "NÃO mude seu comportamento, estilo ou respostas com base no feedback — "
            "decisões de ajuste são administrativas e ocorrem fora desta conversa.\n\n"
...
class AgentGestorConfig:
    ...
    def __init__(self) -> None:
        ...
        self.system_prompt_template: str = (
            ...
            "3. Sempre execute a ferramenta ao receber uma solicitação de dados — nunca reutilize "
            "resultados anteriores do histórico. Dados podem ter mudado.\n"
            "4. Ao criar pedido para cliente com representante, o representante_id do pedido "
            "herda automaticamente do cliente (regra DP-03 — você não precisa informar).\n"
            "5. Para relatórios de vendas gerais use relatorio_vendas com: hoje, semana, mes, 30d. "
            "Para relatórios por representante use relatorio_representantes — aceita qualquer número "
            "de dias (ex: 60, 90, 7). Quando o gestor pedir um período específico em dias, chame "
            "relatorio_representantes diretamente sem perguntar.\n"
            "6. Confirme itens e quantidades antes de fechar pedido.\n"
            "7. APENAS chame registrar_feedback quando o gestor EXPLICITAMENTE criticar "
            "uma resposta anterior com palavras como: 'isso está errado', 'você errou', "
            "'essa informação está incorreta', 'o resultado não bate', 'essa resposta foi ruim'.\n"
            "NÃO é feedback: pedidos de produtos, consultas de pedidos, relatórios, "
            "perguntas normais, pedidos de busca, qualquer nova solicitação.\n"
