# Product Specs — AI Sales Agent

Especificacoes de produto por feature. Cada spec descreve o comportamento
esperado do ponto de vista do usuario, independente da implementacao.

## Indice

| Feature | Arquivo | Status |
|---------|---------|--------|
| Crawler de catalogo | catalog-crawler.md | pendente |
...
com base no feedback do Evaluator e dos usuarios.
